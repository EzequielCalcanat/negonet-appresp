            ...
            <div className='container-fluid containertext divinclinado text-center'>
                <div className='row divtextinclinado fs-5'>
                    <div className="col-lg-4 contents">
                        <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-bandaid-fill icontext" viewBox="0 0 16 16">
                    ...
                    <div className="col-lg-4 contents">
                        <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-gear-wide-connected icontext" viewBox="0 0 16 16">
                    ...
                    <div className="col-lg-4 contents">
                        <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-egg-fried icontext" viewBox="0 0 16 16">
